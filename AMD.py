...
DOMANDE = [
    ("Frutta", "Quante porzioni di frutta consumi per pasto principale?", ["0", "1", "2 o più"], "2 o più", 3),
    ("Verdura", "Quante porzioni di verdura consumi per pasto principale?", ["0", "1", "2 o più"], "2 o più", 3),
    ("Cereali", "Quante porzioni di cereali (pane, pasta, riso, ecc.) consumi per pasto principale?", ["0", "1", "2 o più"], "2 o più", 3),
    ("Patate", "Quante porzioni di patate consumi a settimana?", [">3", "3 o meno"], "3 o meno", 1),
    ("Olio d’oliva", "Usi olio d’oliva ad ogni pasto principale?", ["Sì", "No"], "Sì", 3),
    ("Frutta secca", "Quante porzioni di frutta secca consumi al giorno?", ["0", "1", "2 o più"], ["1", "2 o più"], 2),
    ("Latticini", "Quante porzioni di latticini consumi al giorno?", ["0", "1", "2 o più"], "2 o più", 2),
    ...
    ("Carne bianca", "Quante porzioni di carne bianca (pollo, tacchino) consumi a settimana?", ["<2", "2 o più"], "2 o più", 1),
    ("Carne rossa", "Quante porzioni di carne rossa consumi a settimana?", [">=2", "<2"], "<2", 1),
    ("Dolci", "Quante porzioni di dolci e zuccheri consumi a settimana?", [">2", "≤2"], "≤2", 1),
    ("Bevande alcoliche", "Quante unità di vino o birra consumi al giorno?", ["0", "1-2", ">2"], "1-2", 1),
]
